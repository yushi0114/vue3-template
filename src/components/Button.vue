...
<template>
    <button v-bind="$attrs" :data-type="type" class="i-btn" :disabled="disabled" :class="[
        'i-btn-' + size,
        'i-btn-' + type,
        'i-btn-' + color,
        block ? 'i-btn-block' : '',
...
<style lang="postcss">
.i-btn {
    @apply font-medium text-sm appearance-none rounded transition duration-150 ease-in-out shadow-sm border border-white z-0 hover: z-10;
}
