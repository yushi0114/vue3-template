...
import {
    currentCategoryId, formType,
    mode,
    financeFilterObject,
    categoryForm,
    categoryList, setOrgTypeModuleList, setFinanceCategoryList, setAllSystemMenuTree
} from './category-list';
import {LoadingService} from '@/views/system/loading-service';
import type {FinanceCategoryListItemType} from '@/views/finance/type/finance-category.type';
import {deleteFinanceCategory} from '@/api/finance/finance-category';
